  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.chartCard}>
        <Text style={styles.chartTitle}>Harvest Trend (Last 30 Days)</Text>
        <LineChart
          data={{
            labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4', 'Week 5', 'Week 6', 'Now'],
            datasets: [
              {
                data: metrics.harvestData.length > 0 ? metrics.harvestData : [0],
              },
            ],
          }}
      ...
      <View style={styles.chartCard}>
        ...
        <BarChart
          data={{
            ...
            datasets: [
              {
                data: metrics.monthlyData.map(d => d.income / 1000),
                color: (opacity = 1) => `rgba(76, 175, 80, ${opacity})`,
              },
              {
                data: metrics.monthlyData.map(d => d.expense / 1000),
          ...
          style={styles.chart}
        />
        <Text style={styles.chartSubtext}>Values in thousands (₹K)</Text>
      </View>
